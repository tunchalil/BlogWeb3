<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GirisYapKullanici.aspx.cs" Inherits="BlogWeb3.GirisYapKullanici" %>
...
<head>
	...
	<script src='//production-assets.codepen.io/assets/editor/live/console_runner-079c09a0e3b9ff743e39ee2d5637b9216b3545af0de366d4b9aad9dc87e26bfd.js'>
	         ...
	         </script><script src='//production-assets.codepen.io/assets/editor/live/css_live_reload_init-2c0dc5167d60a5af3ee189d570b1835129687ea2a61bee3513dee3a50c115a77.js'></script><meta charset='UTF-8'>
...
<div class="login">
    ...
    <form runat="server">
        ...
        <button type="button" runat="server" class="btn btn-primary btn-block btn-large" onserverclick="btnClk">Giriş Yap</button>
	
		<br />

		<div>
			<button type="button" class="btn btn-primary btn-block btn-dark btn-large" onclick='adminYukle();'>Admin Girişi</button>
		</div>

		<br />

		<div>
			 <button type="button"  class="btn btn-primary btn-block btn-danger btn-large" onclick='uyeOlSayfasi();'>Üye Ol</button>
		</div>
	...
	<script>
		...
		function adminYukle() {
			location.href = 'GirisYapAdmin.aspx';
		}

		function uyeOlSayfasi() {
            location.href = 'UyeOl.aspx';
        }
