<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="defaultAdmin.aspx.cs" Inherits="BlogWeb3.defaultAdmin" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="AdminDeneyim.Aspx">Admin Paneli</a>
                </li>
