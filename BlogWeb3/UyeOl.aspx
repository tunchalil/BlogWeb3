<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UyeOl.aspx.cs" Inherits="BlogWeb3.UyeOl" %>
...
<div class="login">
    ...
    <form runat="server">
		...
		<asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" PlaceHolder="Şifre Tekrar"  TextMode="Password" ></asp:TextBox>
        <button type="button" runat="server"  class="btn btn-primary btn-block btn-large" onserverclick="btnClk">Üye Ol</button>

		<br />

		<button type="button" class="btn btn-primary btn-block btn-large" onclick='UyeGirisiYukle();'>Zaten Üye misin / Giriş Yap</button>
...
<script>
	...
	function UyeGirisiYukle() {
        
		location.href = 'GirisYapKullanici.Aspx';
